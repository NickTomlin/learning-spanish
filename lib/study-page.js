    ...
    <header class="study-header">
      <div class="header-top">
        ...
        <div class="print-links">
          <a class="print-link" data-ref="worksheet-link" href="worksheet.html?sheet=${encodeURIComponent(sheet.id)}" aria-label="Printable worksheet">🖨 <span class="print-link-label-full" data-ref="worksheet-link-label">Printable worksheet</span><span class="print-link-label-short">Worksheet</span></a>
          <a class="print-link" data-ref="reference-link" href="worksheet.html?sheet=${encodeURIComponent(sheet.id)}&amp;doc=reference" aria-label="Reference sheet">🖨 <span class="print-link-label-full">Reference sheet</span><span class="print-link-label-short">Reference</span></a>
        </div>
      </div>
      <nav class="tabs">
